...
import net.astrospud.astrovariety.screen.slot.AVFuelSlot;
import net.astrospud.astrovariety.screen.slot.AVResultSlot;
...
public class AlchemistTableScreenHandler extends ScreenHandler {
    ...
    public AlchemistTableScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
        super(AVScreenHandlers.ALCHEMIST_TABLE_SCREEN_HANDLER, syncId);
