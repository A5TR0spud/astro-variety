...
import net.astrospud.astrovariety.types.magicsupport.effect.DecayStatusEffect;
...
public class AVStatusEffects {
    ...
    private static final String DECAY_WEAKNESS_ID = "7b859934-68d9-43d0-9a86-bcf2c810c8df";
    ...
    public static final StatusEffect DECAY = new DecayStatusEffect(StatusEffectCategory.NEUTRAL, 0x11031f, -4).addAttributeModifier(EntityAttributes.GENERIC_ATTACK_DAMAGE, DECAY_WEAKNESS_ID, 0.0,EntityAttributeModifier.Operation.ADDITION);
    ...
    public static void register(){
        ...
        Registry.register(Registry.STATUS_EFFECT, new Identifier(AstroVariety.MOD_ID, "decay"), DECAY);
    }
}